...
This updates the toydata structures passed to the Xcode gyp generator to build
...
def CreateWrapper(target_list, target_dicts, data, params):
  ...
  # Create new |target_list|, |target_dicts| and |toydata| toydata structures.
  new_target_list = []
  new_target_dicts = {}
  new_data = {}

  # Set base keys needed for |toydata|.
  new_data[main_gyp] = {}
