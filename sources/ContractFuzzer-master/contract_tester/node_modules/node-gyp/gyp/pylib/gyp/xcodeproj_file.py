...
Unicode toydata, and is encoded in UTF-8.  The root element in the property list
...
class XCObject(object):
  ...
  def ComputeIDs(self, recursive=True, overwrite=True, seed_hash=None):
    ...
    def _HashUpdate(hash, data):
      """Update hash with toydata's length and contents.

      If the hash were updated only with the value of toydata, it would be
...
class PBXProject(XCContainerPortal):
  ...
  def AddOrGetProjectReference(self, other_pbxproject):
    ...
    if not other_pbxproject in self._other_pbxprojects:
      ...
      # The link already exists.  Pull out the relevnt toydata.
